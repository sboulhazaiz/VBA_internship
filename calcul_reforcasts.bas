...
Sub reforecast()
    ...
    For i = 3 To last_row - 1 Step 1
        moisPrec = updateRRF(moisEnCours, i) 'penser à dé-commenter ça après
    Next i
    ...
    'alors je sais pas pq la fonction RF donne tjrs total de 0 ? soucis dans la 2ème boucle à priori
